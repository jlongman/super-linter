...
# docker run -v $PWD/./scripts/plat-5:/tmp/lint -e RUN_LOCAL=true -eVALIDATE_PYTHON_PYLINT=true  --rm -it jlongman/super-linter:stable
...
# scripts/plat-5/redis-snapshot-export.py:86:4: E1120: No value for argument 'instance_name' in function call (no-value-for-parameter)
# scripts/plat-5/redis-snapshot-export.py:86:4: E1120: No value for argument 'jira_issue' in function call (no-value-for-parameter)]
